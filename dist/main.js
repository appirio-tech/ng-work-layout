...
angular.module("appirio-tech-ng-work-layout").run(["$templateCache", function($templateCache) {$templateCache.put("views/layout-main.directive.html","<main role=\"main\" ui-view=\"\" class=\"layout-main {{ vm.pageClass }}\"></main>");
